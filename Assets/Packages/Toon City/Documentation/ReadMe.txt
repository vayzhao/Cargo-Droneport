...
Make sure you have the V2 Post Processing Stack imported in your project, if you are using the Standard Render Pipeline.
...
The textures used by the materials are very small in size: the diffuse 
